...
<title>포고5t (${fn:length(pogo5List)})</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>" />
<script type="text/javaScript" language="javascript" defer="defer">
<!--
    function fn_egov_append() {
        document.listForm.action = "<c:url value='/appendPogo5t.do'/>";
        document.listForm.submit();
    }

    function fn_egov_update() {
        document.listForm.action = "<c:url value='/updatePogo5t.do'/>";
        document.listForm.submit();
    }
    ...
    function fn_egov_delete(seq) {
        ...
        document.listForm.action = "<c:url value='/deletePogo5t.do'/>";
        document.listForm.submit();
    }
    ...
    function fn_egov_insert(seq) {
        ...
        document.listForm.action = "<c:url value='/insertPogo5t.do'/>";
        document.listForm.submit();
    }
